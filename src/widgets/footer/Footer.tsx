      ...
      <div className="footer-row">
        ...
        <div className="footer-identity">
          ...
          <div className="footer-name-block">
            <span className="footer-name">Đỗ Anh Thịnh</span>
            <span className="footer-sep">·</span>
            <span className="footer-role">Thạc sĩ Kỹ thuật điện tử</span>
          </div>
        </div>
        ...
        <div className="footer-socials">
          <a href="https://linkedin.com/in/mellivora24" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="LinkedIn">
          ...
          <a href="https://scholar.google.com" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Scholar">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 24a7 7 0 1 1 0-14 7 7 0 0 1 0 14zm0-24L0 9.5l4.838 3.94A8 8 0 0 1 12 10a8 8 0 0 1 7.162 3.44L24 9.5z" />
            </svg>
          </a>
          <a href="https://github.com/mellivora24" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="GitHub">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Copyright */}
        <p className="footer-copy">© {currentYear} Đỗ Anh Thịnh</p>
